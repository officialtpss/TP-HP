...
const tableName = 'project_commodity';

const ProjectCommodity = sequelize.define(
  'ProjectCommodity',
  {
    container_type: {
      type: Sequelize.TEXT,
...
ProjectCommodity.prototype.toJSON = function () {
  const values = Object.assign({}, this.get());
  return values;
};

module.exports = ProjectCommodity;
